...
const Engine = () => {
    return (
        ...
        >
            <g id="engine_power" data-name="engine power">
                <path
                    d="m61 24v20a2.006 2.006 0 0 1 -2 2h-2v-24h2a2.006 2.006 0 0 1 2 2z"
                    fill="#ffde55"
                />
                <path d="m53 32h4v4h-4z" fill="#e0e0e2" />
                <path
                    d="m55 11v2h-28v-2a4 4 0 0 1 4-4h20a4 4 0 0 1 4 4z"
                    fill="#ff3051"
                />
                <path
                    d="m61 24v20a2.006 2.006 0 0 1 -2 2h-2a2.006 2.006 0 0 0 2-2v-20a2.006 2.006 0 0 0 -2-2h2a2.006 2.006 0 0 1 2 2z"
                    fill="#ffcd00"
                />
                <path
                    d="m55 11v2h-4v-2a4 4 0 0 0 -4-4h4a4 4 0 0 1 4 4z"
                    fill="#cd2a00"
                />
                <path
                    d="m47 37.9v-3.8l-3.25-.41a6.022 6.022 0 0 0 -.34-.83l2.01-2.58-2.7-2.7-2.58 2.01a6.022 6.022 0 0 0 -.83-.34l-.41-3.25h-3.8l-.41 3.25a6.022 6.022 0 0 0 -.83.34l-2.58-2.01-2.42 2.42h-3.76l-.41 3.25a6.022 6.022 0 0 0 -.83.34l-2.58-2.01-2.7 2.7 2.01 2.58a6.022 6.022 0 0 0 -.34.83l-3.25.41v3.8l3.25.41a6.022 6.022 0 0 0 .34.83l-2.01 2.58 2.7 2.7 2.58-2.01a6.022 6.022 0 0 0 .83.34l.41 3.25h3.8l.41-3.25a6.022 6.022 0 0 0 .83-.34l2.58 2.01 2.42-2.42h3.76l.41-3.25a6.022 6.022 0 0 0 .83-.34l2.58 2.01 2.7-2.7-2.01-2.58a6.022 6.022 0 0 0 .34-.83z"
                    fill="#e0e0e2"
                />
                <path
                    d="m53 21v27h-7l-3.47 7.81a2.008 2.008 0 0 1 -1.83 1.19h-27.7a2.006 2.006 0 0 1 -2-2v-27a2.006 2.006 0 0 1 2-2h6l10.1-7h21.9a2.006 2.006 0 0 1 2 2z"
                    fill="#e0e0e2"
                />
                <path
                    d="m42 48h4l-3.47 7.81a2.008 2.008 0 0 1 -1.83 1.19h-4a2.008 2.008 0 0 0 1.83-1.19z"
                    fill="#c6c5ca"
                />
                <path
                    d="m53 21v27h-4v-27a2.006 2.006 0 0 0 -2-2h4a2.006 2.006 0 0 1 2 2z"
                    fill="#c6c5ca"
                />
                <path
                    d="m47 34.1v3.8l-3.25.41a6.022 6.022 0 0 1 -.34.83l2.01 2.58-2.7 2.7-2.58-2.01a6.022 6.022 0 0 1 -.83.34l-.41 3.25h-3.76l.28-.28-.42-.54-1.59-2.04c.09-.19.17-.37.25-.57v-.01c.03-.08.06-.16.09-.25l3.25-.41v-1.9a4 4 0 1 0 -2.76-6.9l-1.52-1.52-2.38 1.85-.2.16a6.022 6.022 0 0 0 -.83-.34l-.45-3.25 2.42-2.42 2.58 2.01a6.022 6.022 0 0 1 .83-.34l.41-3.25h3.8l.41 3.25a6.022 6.022 0 0 1 .83.34l2.58-2.01 2.7 2.7-2.01 2.58a6.022 6.022 0 0 1 .34.83z"
                    fill="#a78966"
                />
                <path d="m38 13h6v6h-6z" fill="#e0e0e2" />
                <path d="m42 13h2v6h-2z" fill="#c6c5ca" />
                <path
                    d="m37 32a4 4 0 0 1 0 8v-1.9l-3.25-.41a6.022 6.022 0 0 0 -.34-.83l2.01-2.58-1.18-1.18a4.007 4.007 0 0 1 2.76-1.1z"
                    fill="#ffde55"
                />
                <path
                    d="m37 40v1.9l-3.25.41c-.03.09-.06.17-.09.25v.01c-.08.2-.16.38-.25.57l1.59 2.04.42.54-.28.28-2.42 2.42-2.58-2.01a6.022 6.022 0 0 1 -.83.34l-.41 3.25h-3.8l-.41-3.25a6.022 6.022 0 0 1 -.83-.34l-2.58 2.01-2.7-2.7 2.01-2.58a6.022 6.022 0 0 1 -.34-.83l-3.25-.41v-3.8l3.25-.41a6.022 6.022 0 0 1 .34-.83l-2.01-2.58 2.7-2.7 2.58 2.01a6.022 6.022 0 0 1 .83-.34l.41-3.25h3.76l.45 3.25a6.022 6.022 0 0 1 .83.34l.2-.16 2.38-1.85 1.52 1.52 1.18 1.18-2.01 2.58a6.022 6.022 0 0 1 .34.83l3.25.41zm-6 0a4 4 0 1 0 -4 4 4 4 0 0 0 4-4z"
                    fill="#c0ab91"
                />
                <circle cx="27" cy="40" fill="#ffde55" r="4" />
                <path d="m7 42h4v4h-4z" fill="#e0e0e2" />
                <path
                    d="m7 46v10h-2a2.006 2.006 0 0 1 -2-2v-20a2.006 2.006 0 0 1 2-2h2z"
                    fill="#ffde55"
                />
                <path d="m59 21h-2a1 1 0 0 0 -1 1v9h-2v-10a3.009 3.009 0 0 0 -3-3h-6v-4h10a1 1 0 0 0 1-1v-2a5 5 0 0 0 -5-5h-20a5 5 0 0 0 -5 5v2a1 1 0 0 0 1 1h10v4h-7.9a.944.944 0 0 0 -.57.18l-9.84 6.82h-5.69a3.009 3.009 0 0 0 -3 3v13h-2v-9a1 1 0 0 0 -1-1h-2a3.009 3.009 0 0 0 -3 3v20a3.009 3.009 0 0 0 3 3h2a1 1 0 0 0 1-1v-9h2v8a3.009 3.009 0 0 0 3 3h27.7a3.006 3.006 0 0 0 2.74-1.78l3.21-7.22h6.35a1 1 0 0 0 1-1v-11h2v9a1 1 0 0 0 1 1h2a3.009 3.009 0 0 0 3-3v-20a3.009 3.009 0 0 0 -3-3zm-53 34h-1a1 1 0 0 1 -1-1v-20a1 1 0 0 1 1-1h1zm4-10h-2v-2h2zm18-33v-1a3.009 3.009 0 0 1 3-3h20a3.009 3.009 0 0 1 3 3v1zm15 2v4h-4v-4zm9 33h-6a.987.987 0 0 0 -.91.59l-3.48 7.82a1 1 0 0 1 -.91.59h-27.7a1 1 0 0 1 -1-1v-27a1 1 0 0 1 1-1h6a.988.988 0 0 0 .57-.18l9.84-6.82h21.59a1 1 0 0 1 1 1zm4-12h-2v-2h2zm4 9a1 1 0 0 1 -1 1h-1v-22h1a1 1 0 0 1 1 1z" />
